...
# Los módulos legacy per-institución fueron retirados (2026-06-09); su lógica vive
# ahora en los scrapers genéricos de scrapers/plataformas/ declarados arriba.
# Se conserva la infraestructura (LegacyModule, iter_legacy_rows, is_legacy_module)
# por si se necesita deprecar módulos en el futuro, pero el inventario está vacío.
