...
def normalize_job_posting(
    ...
    return JobPosting(
        ...
        emails_found=extraction.emails_found,
        email_postulacion=extraction.email_postulacion,
        email_consultas=extraction.email_consultas,
        email_indeterminado=extraction.email_indeterminado,
        email_contexts=extraction.email_contexts,
        postulacion_channel=extraction.postulacion_channel,
        has_consultation_channel=extraction.has_consultation_channel,
        salary_validation_status=extraction.salary_validation_status,
        salary_trace=extraction.salary_trace,
