...
def get_ofertas(
    ...
    order_sql = {
        ...
        "renta_desc": "renta_bruta_max DESC NULLS LAST, renta_bruta_min DESC NULLS LAST, id DESC",
        "renta":      "renta_bruta_max DESC NULLS LAST, renta_bruta_min DESC NULLS LAST, id DESC",
        "renta_asc":  "LEAST(COALESCE(renta_bruta_min, renta_bruta_max), COALESCE(renta_bruta_max, renta_bruta_min)) ASC NULLS LAST, id DESC",
        "az":         "cargo ASC NULLS LAST, id ASC",
